                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <img src="{{ asset("images/small/user-pro.jpg") }}" alt="" class="img-fluid">
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="met-basic-detail">
                                                        ...
                                                        <div class="my-3">
                                                            <button class="btn btn-gradient-primary px-3">Hire Me</button>
                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <img src="{{ asset("images/widgets/education.svg") }}" alt="" class="img-fluid">
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row container-grid nf-col-3  projects-wrapper">
                                                <div class="col-lg-4 col-md-6 p-0 nf-item branding design coffee spacing">
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image" href="{{ asset("images/small/img-1.jpg") }}" title="Consequat massa quis">
                                                            <img class="item-container " src="{{ asset("images/small/img-1.jpg") }}" alt="7" />
                                                            <div class="item-mask">
                                                ...
                                                <div class="col-lg-4 col-md-6 p-0 nf-item photo spacing">
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image" href="{{ asset("images/small/img-2.jpg") }}" title="Vivamus elementum semper">
                                                            <img class="item-container mfp-fade" src="{{ asset("images/small/img-2.jpg") }}" alt="2" />
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                ...
                                                <div class="col-lg-4 col-md-6 p-0 nf-item branding coffee spacing">
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image" href="{{ asset("images/small/img-3.jpg") }}" title="Quisque rutrum">
                                                            <img class="item-container" src="{{ asset("images/small/img-3.jpg") }}" alt="4" />
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                ...
                                                <div class="col-lg-4 col-md-6 p-0 nf-item branding design spacing">
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image" href="{{ asset("images/small/img-4.jpg") }}" title="Tellus eget condimentum">
                                                            <img class="item-container" src="{{ asset("images/small/img-4.jpg") }}" alt="5" />
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                ...
                                                <div class="col-lg-4 col-md-6 p-0 nf-item branding design spacing">
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image" href="{{ asset("images/small/img-5.jpg") }}" title="Nullam quis ant">
                                                            <img class="item-container" src="{{ asset("images/small/img-5.jpg") }}" alt="6" />
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                ...
                                                <div class="col-lg-4 col-md-6 p-0 nf-item photo spacing">
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image" href="{{ asset("images/small/img-6.jpg") }}" title="Sed fringilla mauris">
                                                            <img class="item-container" src="{{ asset("images/small/img-6.jpg") }}" alt="1" />
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="">
                                                                <img src="{{ asset("images/users/user-10.jpg") }}" alt="" class="rounded-circle thumb-lg mb-2">
                                                    ...
                                                    <div class="carousel-item active">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="">
                                                                <img src="{{ asset("images/users/user-4.jpg") }}" alt="" class="rounded-circle  thumb-lg mb-2">
                                                    ...
                                                    <div class="carousel-item">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="">
                                                                <img src="{{ asset("images/users/user-5.jpg") }}" alt="" class="rounded-circle  thumb-lg mb-2">
