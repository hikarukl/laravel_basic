<div class="left-sidenav">
    <div class="main-icon-menu">
        <nav class="nav">
            ...
            <a href="#MetricaCrypto" class="nav-link leftmenu-sm-item bg-warning shadow-warning" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Crypto">
    ...
    <div class="main-menu-inner">
        <div class="menu-body slimscroll">
            ...
            <div id="MetricaCrypto" class="main-icon-menu-pane">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ route("coin.index") }}"><i class="dripicons-device-desktop"></i>Calculate</a></li>
                </ul>
            </div><!-- end Crypto -->
