    ...
    <div class="container mx-auto xl:pl-0 xl:pr-0">
        <div class="grid grid-cols-1 md:grid-cols-3 text-left text-white pb-5 pl-5 pr-5">
            <div class="md:col-span-3">
                <img class="w-6/12 md:w-1/12 p-0 pt-5 pb-5" src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg">
            </div>
            <p class="md:col-span-3 mb-5">Công ty TNHH ABC là công ty truyền thông chuyên về lĩnh vực thông tin điện tử.</p>
